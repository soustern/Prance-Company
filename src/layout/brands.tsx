...
const Brands = ({fontsReady}: brandsProps): JSX.Element => {
    ...
    return (
        <section id="brands-section" className="bg-slate-200 flex flex-col items-center justify-center relative px-10 py-16 overflow-hidden">
            <div>
            ...
            <div className="w-[150%] overflow-x-hidden relative pb-16">
