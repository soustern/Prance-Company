...
const Footer = (): JSX.Element => {
    return (
        <section id="footer-section" style={{clipPath: `polygon(0 0%, 100% 15%, 100% 100%, 0% 100%)`}} className="flex flex-col justify-center relative px-8 py-8 pt-26 bg-gradient-to-tl from-slate-900 to-bg-primary to-60% -mt-22">
