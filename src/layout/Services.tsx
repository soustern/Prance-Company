...
const Services = ({fontsReady}: servicesProps): JSX.Element => {
    ...
    if (size < 975)
    {
        ...
        return (
            <section id="services-section" ref={sectionDesktopRef} style={{backgroundImage: `linear-gradient(to top,rgba(15, 23, 43, 0.7), rgba(15, 23, 43, 0.6)), url(${servicesBackground})`}} className="scroll-mt-50 py-24 z-0 flex flex-col items-center justify-center px-16 relative object-fill bg-no-repeat bg-fit bg-center bg-[#0b1516] gap-20">
                ...
                <div className="flex justify-between w-full max-w-[1200px]">
                    ...
                    <Card ariaLabel="Abrir o WhatsApp da empresa" alt="Imagem da tela de um computador com graficos de performance" ref={thirdCardDesktopRef} className="z-30 card" heading="Mídia Paga & Performance" paragraph="Não basta ser visto, é preciso converter. Estruturamos campanhas inteligentes que transformam atenção em vendas, com métricas sólidas e foco total em resultados." image={card3}></Card>
                </div>
