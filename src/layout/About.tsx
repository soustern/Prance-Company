    ...
    return (
        <section className="bg-[var(--color-bg-primary)] flex flex-col items-center justify-center relative px-4 pt-20">
            <div className="absolute flex left-1/2 -top-10 transform -translate-x-1/2 z-0 gap-0">
                <div className="bg-slate-50 z-30 h-10 w-10 relative transform translate-x-1.5">
                ...
                <div className="bg-slate-50 z-30 h-10 w-10 relative transform -translate-x-1.5">
                    <div className="bg-[var(--color-bg-primary)] h-full w-full rounded-bl-full absolute inset-0 origin-left"></div>
                </div>
            </div>
